...
public:
   ...
   */
  template <typename T> void HookDefaultSink (Ptr<T> object, std::string tracename, Ptr<PcapFileWrapper> file, Ptr<PcapFileWrapper> file2,Ptr<PcapFileWrapper> file3);
...
PcapHelper::HookDefaultSink (Ptr<T> object, std::string tracename, Ptr<PcapFileWrapper> file, Ptr<PcapFileWrapper> file2,Ptr<PcapFileWrapper> file3)
{
  // std::cout<<"outtttt"<<std::endl;
  bool result =
    object->TraceConnectWithoutContext (tracename.c_str (), MakeBoundCallback (&DefaultSink, file));
    bool result2 =
    object->TraceConnectWithoutContext (tracename.c_str (), MakeBoundCallback (&DefaultSink, file2));
    bool result3 =
    object->TraceConnectWithoutContext (tracename.c_str (), MakeBoundCallback (&DefaultSink, file3));
  NS_ASSERT_MSG (result == true, "PcapHelper::HookDefaultSink():  Unable to hook \"" << tracename << "\"");
  NS_ASSERT_MSG (result2 == true, "PcapHelper::HookDefaultSink():  Unable to hook \"" << tracename << "\"");
  NS_ASSERT_MSG (result3 == true, "PcapHelper::HookDefaultSink():  Unable to hook \"" << tracename << "\"");
}
