...
LogComponentEnable ("PacketMetadata", LOG_FUNCTION); 
   LogComponentEnable ("PacketMetadata", LOG_DEBUG);  
   LogComponentEnable ("PacketMetadata", LOG_PREFIX_TIME);  
      LogComponentEnable ("PacketMetadata", LOG_LOGIC); 
      LogComponentEnable ("PacketMetadata", LOG_INFO); 
